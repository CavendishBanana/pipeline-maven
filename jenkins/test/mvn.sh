...
WORKSPACE="/home/gryko/jenkins-data/pipeline/java-app"
...
docker run --rm --mount type=bind,source="$WORKSPACE",target="/app" --mount type=bind,source="/root/.m2",target="/root/.m2/" -w "/app" "maven:3.9.6-eclipse-temurin-17-alpine" "$@"
